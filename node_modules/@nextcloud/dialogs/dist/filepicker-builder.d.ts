import { IFilePickerButton, IFilePickerButtonFactory, IFilePickerCanPick, IFilePickerFilter } from './components/types';
...
export declare class FilePicker<IsMultiSelect extends boolean> {
    ...
    constructor(title: string, multiSelect: IsMultiSelect, mimeTypeFilter: string[], directoriesAllowed: boolean, buttons: IFilePickerButton[] | IFilePickerButtonFactory, path?: string, filter?: IFilePickerFilter, canPick?: IFilePickerCanPick, container?: string, disabledNavigation?: boolean);
    /**
...
export declare class FilePickerBuilder<IsMultiSelect extends boolean> {
     ...
     */
    setCanPick(canPick: IFilePickerCanPick): this;
    /**
