...
const Toastify__default = /* @__PURE__ */ _interopDefault(Toastify);
...
function showMessage(data, options) {
  ...
  const toast = Toastify__default.default({
...
exports.TOAST_ARIA_LIVE_ASSERTIVE = TOAST_ARIA_LIVE_ASSERTIVE;
exports.TOAST_ARIA_LIVE_OFF = TOAST_ARIA_LIVE_OFF;
exports.TOAST_ARIA_LIVE_POLITE = TOAST_ARIA_LIVE_POLITE;
...
exports.ToastAriaLive = ToastAriaLive;
...
exports.t = t;
//# sourceMappingURL=_plugin-vue2_normalizer-MxS9rO0K.cjs.map
